...
.L__stack_usage = 0
	movw r18,r24
	.stabn	68,0,277,.LM19-.LFBB2
.LM19:
	lds r25,112
	andi r25,lo8(-8)
	sts 112,r25
	.stabn	68,0,281,.LM20-.LFBB2
.LM20:
	ldi r24,lo8(32)
	sts 182,r24
	.stabn	68,0,283,.LM21-.LFBB2
.LM21:
	sts 178,__zero_reg__
	.stabn	68,0,287,.LM22-.LFBB2
.LM22:
	ldi r24,lo8(2)
	sts 176,r24
	.stabn	68,0,289,.LM23-.LFBB2
.LM23:
	cpi r18,1
	cpc r19,__zero_reg__
	brne .L14
	.stabn	68,0,293,.LM24-.LFBB2
.LM24:
	ldi r24,lo8(6)
	sts 177,r24
	.stabn	68,0,297,.LM25-.LFBB2
.LM25:
	ldi r24,lo8(-128)
	sts 179,r24
	.stabn	68,0,299,.LM26-.LFBB2
.LM26:
	lds r24,rtc+7
	andi r24,lo8(-4)
	ori r24,lo8(1)
.L18:
	.stabn	68,0,311,.LM27-.LFBB2
.LM27:
	sts rtc+7,r24
.L16:
	.stabn	68,0,317,.LM28-.LFBB2
.LM28:
	lds r24,182
	andi r24,lo8(26)
	brne .L16
	.stabn	68,0,319,.LM29-.LFBB2
.LM29:
	out 0x17,__zero_reg__
	.stabn	68,0,320,.LM30-.LFBB2
.LM30:
	ldi r24,lo8(2)
	sts 112,r24
/* epilogue start */
	.stabn	68,0,323,.LM31-.LFBB2
.LM31:
	ret
.L14:
	.stabn	68,0,305,.LM32-.LFBB2
.LM32:
	ldi r24,lo8(1)
	sts 177,r24
	.stabn	68,0,309,.LM33-.LFBB2
.LM33:
	ldi r24,lo8(33)
	sts 179,r24
	.stabn	68,0,311,.LM34-.LFBB2
.LM34:
	lds r24,rtc+7
	andi r24,lo8(-4)
	rjmp .L18
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,357,.LM48-.LFBB7
.LM48:
	lds r24,rtc+7
	lsr r24
	lsr r24
	andi r24,lo8(3)
	.stabn	68,0,358,.LM49-.LFBB7
.LM49:
	ldi r25,0
/* epilogue start */
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,204,.LM54-.LFBB9
.LM54:
	ldi r30,lo8(rtc)
	ldi r31,hi8(rtc)
	std Z+6,__zero_reg__
	.stabn	68,0,205,.LM55-.LFBB9
.LM55:
	ld r24,Z
	andi r24,lo8(-32)
	ori r24,lo8(12)
	st Z,r24
	.stabn	68,0,206,.LM56-.LFBB9
.LM56:
	ld r24,Z
	andi r24,lo8(31)
	st Z,r24
...
.LM57:
	...
	andi r24,lo8(-2)
	st X,r24
	.stabn	68,0,208,.LM58-.LFBB9
.LM58:
	std Z+4,__zero_reg__
	std Z+3,__zero_reg__
	.stabn	68,0,209,.LM59-.LFBB9
.LM59:
	std Z+5,__zero_reg__
	.stabn	68,0,210,.LM60-.LFBB9
.LM60:
	ldi r30,lo8(rtc+6)
	ldi r31,hi8(rtc+6)
	ldd r24,Z+1
...
.Ltext5:
	.stabn	68,0,70,.LM76-.LFBB13
.LM76:
	out __SREG__,r28
	.stabn	68,0,71,.LM77-.LFBB13
.LM77:
.L31:
.LBE76:
.LBE75:
...
.Ltext6:
	.stabn	68,0,377,.LM78-.LFBB13
.LM78:
	lds r24,rtc+6
.LBE78:
.LBE77:
	.stabn	68,0,198,.LM79-.LFBB13
.LM79:
	sbrs r24,6
	rjmp .L32
/* epilogue start */
	.stabn	68,0,200,.LM80-.LFBB13
.LM80:
	pop r28
	ret
.L32:
	.stabn	68,0,199,.LM81-.LFBB13
.LM81:
/* #APP */
...
.LM107:
	tst r24
	breq .L40
	.stabn	68,0,103,.LM108-.LFBB15
.LM108:
	call disp_enable_unsafe
	.stabn	68,0,104,.LM109-.LFBB15
.LM109:
	lds r24,rtc+7
	andi r24,lo8(15)
	sts rtc+7,r24
	...
	sts rtc+8,r24
.L40:
	.stabn	68,0,108,.LM110-.LFBB15
.LM110:
	call deferred_isr
	.stabn	68,0,109,.LM111-.LFBB15
.LM111:
	call display_isr
	.stabn	68,0,110,.LM112-.LFBB15
.LM112:
	call strobe_isr
	.stabn	68,0,111,.LM113-.LFBB15
.LM113:
	call sd_card_isr
	.stabn	68,0,113,.LM114-.LFBB15
.LM114:
	lds r24,rtc+3
	lds r25,rtc+3+1
...
.LBB80:
.LBB81:
	.stabn	68,0,377,.LM126-.LFBB15
.LM126:
	lds r24,rtc+6
.LBE81:
.LBE80:
.LBE79:
	.stabn	68,0,122,.LM127-.LFBB15
.LM127:
	sbrs r24,7
	rjmp .L44
.LBB82:
...
.LBE83:
.LBE82:
	.stabn	68,0,123,.LM129-.LFBB15
.LM129:
	brne .L44
	.stabn	68,0,124,.LM130-.LFBB15
.LM130:
	call disp_disable_unsafe
.L44:
	.stabn	68,0,127,.LM131-.LFBB15
.LM131:
	lds r25,rtc+1
	lsr r25
	lsr r25
...
.LBB85:
.LBB86:
	.stabn	68,0,377,.LM147-.LFBB15
.LM147:
	lds r24,rtc+6
.LBE86:
.LBE85:
	.stabn	68,0,147,.LM148-.LFBB15
.LM148:
	call batmon_isr
.L46:
	.stabn	68,0,150,.LM149-.LFBB15
.LM149:
	ldi r24,lo8(4)
	ldi r25,0
...
.LBE88:
.LBE87:
	.stabn	68,0,152,.LM151-.LFBB15
.LM151:
	brne .L42
	.stabn	68,0,154,.LM152-.LFBB15
.LM152:
	ldi r24,lo8(3)
	ldi r25,0
	call rtc_flag_set
...
.LBB91:
.LBB92:
	.stabn	68,0,377,.LM153-.LFBB15
.LM153:
	lds r24,rtc+6
.LBE92:
.LBE91:
.LBE90:
	.stabn	68,0,156,.LM154-.LFBB15
.LM154:
	sbrs r24,7
	rjmp .L42
	.stabn	68,0,157,.LM155-.LFBB15
.LM155:
	lds r20,rtc+6
...
.LBE97:
.LBE96:
	.stabn	68,0,168,.LM168-.LFBB15
.LM168:
	cpi r24,lo8(1)
	breq .L51
	cpi r24,lo8(2)
	brne .L52
	.stabn	68,0,171,.LM169-.LFBB15
.LM169:
	ldi r24,lo8(1)
	ldi r25,0
	call rtc_flag_set
	.stabn	68,0,172,.LM170-.LFBB15
.LM170:
	ldi r24,lo8(2)
	ldi r25,0
.L56:
	.stabn	68,0,177,.LM171-.LFBB15
.LM171:
	call rtc_flag_toggle
.L52:
.LBB98:
.LBB99:
.LBB100:
	.stabn	68,0,377,.LM172-.LFBB15
.LM172:
	lds r24,rtc+6
.LBE100:
.LBE99:
.LBE98:
	.stabn	68,0,181,.LM173-.LFBB15
.LM173:
	sbrs r24,7
	rjmp .L34
	.stabn	68,0,187,.LM174-.LFBB15
.LM174:
	lds r20,rtc+6
	.stabn	68,0,186,.LM175-.LFBB15
.LM175:
	lds r24,rtc
	swap r24
	lsr r24
...
.LM177:
	...
	rjmp .L34
.L51:
	.stabn	68,0,176,.LM178-.LFBB15
.LM178:
	ldi r24,lo8(2)
	ldi r25,0
	call rtc_flag_set
	.stabn	68,0,177,.LM179-.LFBB15
.LM179:
	ldi r24,lo8(1)
	ldi r25,0
	rjmp .L56
...
.LM190:
	...
	lsl r24
	or r24,r25
	.stabn	68,0,385,.LM191-.LFBB17
.LM191:
	sbrs r21,7
	rjmp .L62
	.stabn	68,0,386,.LM192-.LFBB17
.LM192:
	subi r24,lo8(-(63))
.L66:
	.stabn	68,0,388,.LM193-.LFBB17
.LM193:
	andi r24,lo8(63)
	mov r19,r24
	swap r19
...
.Ltext9:
	.stabn	68,0,70,.LM195-.LFBB17
.LM195:
	out __SREG__,r18
	.stabn	68,0,71,.LM196-.LFBB17
.LM196:
.L59:
/* epilogue start */
.LBE120:
...
.Ltext10:
	.stabn	68,0,405,.LM197-.LFBB17
.LM197:
	ret
.L62:
.LBB123:
	.stabn	68,0,388,.LM198-.LFBB17
.LM198:
	subi r24,lo8(-(1))
	rjmp .L66
.L60:
...
.Ltext12:
	.stabn	68,0,397,.LM201-.LFBB17
.LM201:
	lds r25,rtc
	.stabn	68,0,396,.LM202-.LFBB17
.LM202:
	sbrs r21,7
	rjmp .L64
	.stabn	68,0,397,.LM203-.LFBB17
.LM203:
	subi r25,lo8(-(31))
.L67:
	.stabn	68,0,399,.LM204-.LFBB17
.LM204:
	andi r25,lo8(31)
	lds r24,rtc
	andi r24,lo8(-32)
