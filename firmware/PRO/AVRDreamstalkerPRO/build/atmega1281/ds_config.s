...
.L__stack_usage = 0
	movw r18,r24
	.stabn	68,0,565,.LM135-.LFBB39
.LM135:
	sbiw r24,3
	cpi r24,-18
	cpc r25,__zero_reg__
	brsh .L49
	.stabn	68,0,565,.LM136-.LFBB39
.LM136:
	sts cfg+3+1,r19
	sts cfg+3,r18
.L49:
/* epilogue start */
	.stabn	68,0,565,.LM137-.LFBB39
.LM137:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,566,.LM159-.LFBB50
.LM159:
	cpi r24,lo8(10)
	brsh .L66
	.stabn	68,0,566,.LM160-.LFBB50
.LM160:
	sts cfg+5,r24
.L66:
/* epilogue start */
	.stabn	68,0,566,.LM161-.LFBB50
.LM161:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,567,.LM171-.LFBB55
.LM171:
	cpi r24,lo8(10)
	brsh .L76
	.stabn	68,0,567,.LM172-.LFBB55
.LM172:
	sts cfg+6,r24
.L76:
/* epilogue start */
	.stabn	68,0,567,.LM173-.LFBB55
.LM173:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,568,.LM183-.LFBB60
.LM183:
	cpi r24,lo8(10)
	brsh .L86
	.stabn	68,0,568,.LM184-.LFBB60
.LM184:
	sts cfg+12,r24
.L86:
/* epilogue start */
	.stabn	68,0,568,.LM185-.LFBB60
.LM185:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,569,.LM197-.LFBB66
.LM197:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L96
	.stabn	68,0,569,.LM198-.LFBB66
.LM198:
	sts cfg+7,r24
.L96:
/* epilogue start */
	.stabn	68,0,569,.LM199-.LFBB66
.LM199:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,570,.LM211-.LFBB72
.LM211:
	cpi r24,lo8(65)
	brsh .L106
	.stabn	68,0,570,.LM212-.LFBB72
.LM212:
	sts cfg+8,r24
.L106:
/* epilogue start */
	.stabn	68,0,570,.LM213-.LFBB72
.LM213:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,571,.LM229-.LFBB80
.LM229:
	ldi r25,lo8(-2)
	add r25,r24
	cpi r25,lo8(6)
	brsh .L116
	.stabn	68,0,571,.LM230-.LFBB80
.LM230:
	sts cfg+9,r24
.L116:
/* epilogue start */
	.stabn	68,0,571,.LM231-.LFBB80
.LM231:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,574,.LM259-.LFBB94
.LM259:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L152
	.stabn	68,0,574,.LM260-.LFBB94
.LM260:
	sts cfg+13,r24
.L152:
/* epilogue start */
	.stabn	68,0,574,.LM261-.LFBB94
.LM261:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,575,.LM271-.LFBB99
.LM271:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L162
	.stabn	68,0,575,.LM272-.LFBB99
.LM272:
	sts cfg+14,r24
.L162:
/* epilogue start */
	.stabn	68,0,575,.LM273-.LFBB99
.LM273:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,576,.LM283-.LFBB104
.LM283:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L172
	.stabn	68,0,576,.LM284-.LFBB104
.LM284:
	sts cfg+15,r24
.L172:
/* epilogue start */
	.stabn	68,0,576,.LM285-.LFBB104
.LM285:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,577,.LM295-.LFBB109
.LM295:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L182
	.stabn	68,0,577,.LM296-.LFBB109
.LM296:
	sts cfg+16,r24
.L182:
/* epilogue start */
	.stabn	68,0,577,.LM297-.LFBB109
.LM297:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,578,.LM309-.LFBB115
.LM309:
	cpi r24,lo8(100)
	brsh .L192
	.stabn	68,0,578,.LM310-.LFBB115
.LM310:
	sts cfg+17,r24
.L192:
/* epilogue start */
	.stabn	68,0,578,.LM311-.LFBB115
.LM311:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,579,.LM321-.LFBB120
.LM321:
	cpi r24,lo8(100)
	brsh .L202
	.stabn	68,0,579,.LM322-.LFBB120
.LM322:
	sts cfg+18,r24
.L202:
/* epilogue start */
	.stabn	68,0,579,.LM323-.LFBB120
.LM323:
	ret
