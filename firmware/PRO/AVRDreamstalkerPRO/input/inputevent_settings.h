...
#define INPUT_NO_OF_INPUTS					7	//The maximum number of inputs.  This is used to determine the data type
...
#define INPUT_DEBOUNCE_CYCLES				5	//Debounce time in ISR cycles (1-255).  It is important to understand this
...
#define INPUT_HOLD_CYCLES_DEFAULT			400	//This variable can be changed in code using an atomic block at any time
												...
												//to 0 will disable hold.

#define INPUT_HOLDREPEAT_CYCLES_DEFAULT		50	//This variable can be changed in code using an atomic block at any time
...
#define INPUT_HOLDREPEAT_CYCLES_FAST		20
