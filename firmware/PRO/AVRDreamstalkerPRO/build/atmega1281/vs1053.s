...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,115,.LM5-.LFBB3
.LM5:
	or r22,r24
	or r23,r25
	.stabn	68,0,117,.LM6-.LFBB3
.LM6:
	ldi r24,lo8(3)
	jmp vs_sci_write
...
.LBE11:
.LBE10:
	.stabn	68,0,138,.LM15-.LFBB6
.LM15:
	mov r22,r17
	mov r23,r29
	ldi r24,lo8(12)
	call vs_sci_write
	.stabn	68,0,144,.LM16-.LFBB6
.LM16:
	mov r23,r28
	lsl r23
	lsl r23
	...
	ldi r24,lo8(13)
	call vs_sci_write
	.stabn	68,0,151,.LM17-.LFBB6
.LM17:
	ldi r22,0
	ldi r23,lo8(16)
	.stabn	68,0,150,.LM18-.LFBB6
.LM18:
	tst r28
	breq .L10
	.stabn	68,0,153,.LM19-.LFBB6
.LM19:
	ldi r23,0
	ldi r22,0
.L10:
	ldi r24,lo8(14)
	call vs_sci_write
	.stabn	68,0,156,.LM20-.LFBB6
.LM20:
	ldi r22,lo8(2)
	ldi r23,0
	ldi r24,lo8(15)
	call vs_sci_write
	.stabn	68,0,160,.LM21-.LFBB6
.LM21:
	ldi r23,0
	ldi r22,0
	ldi r24,0
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,180,.LM27-.LFBB8
.LM27:
	ldi r23,0
	ldi r22,0
	ldi r24,lo8(3)
	call vs_sci_write
	.stabn	68,0,183,.LM28-.LFBB8
.LM28:
	ldi r22,lo8(16)
	ldi r23,0
	ldi r24,lo8(5)
	call vs_sci_write
	.stabn	68,0,186,.LM29-.LFBB8
.LM29:
