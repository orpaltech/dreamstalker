...
/* stack size = 5 */
.L__stack_usage = 5
	.stabn	68,0,160,.LM27-.LFBB3
.LM27:
/* #APP */
 ;  160 "src/main.c" 1
	sei
 ;  0 "" 2
	.stabn	68,0,169,.LM28-.LFBB3
.LM28:
/* #NOAPP */
	call rtc_init
	.stabn	68,0,170,.LM29-.LFBB3
.LM29:
	call remd_init
	.stabn	68,0,171,.LM30-.LFBB3
.LM30:
	call strobe_init
	.stabn	68,0,172,.LM31-.LFBB3
.LM31:
	call leds_init
	.stabn	68,0,173,.LM32-.LFBB3
.LM32:
	call vibro_init
	.stabn	68,0,174,.LM33-.LFBB3
.LM33:
	call deferred_init
	.stabn	68,0,175,.LM34-.LFBB3
.LM34:
	call disp_init
	.stabn	68,0,176,.LM35-.LFBB3
.LM35:
	call batmon_init
	.stabn	68,0,177,.LM36-.LFBB3
.LM36:
	call sound_init
	.stabn	68,0,178,.LM37-.LFBB3
.LM37:
	call keybrd_init
	.stabn	68,0,179,.LM38-.LFBB3
.LM38:
	call menu_init
	.stabn	68,0,181,.LM39-.LFBB3
.LM39:
	call disp_enable
	.stabn	68,0,183,.LM40-.LFBB3
.LM40:
	call adc_enable
	.stabn	68,0,184,.LM41-.LFBB3
.LM41:
	call adc_warm_up
	.stabn	68,0,191,.LM42-.LFBB3
.LM42:
	ldi r25,0
	ldi r24,0
	call rtc_start
	.stabn	68,0,193,.LM43-.LFBB3
.LM43:
	call fw_version
	movw r22,r24
	ldi r20,lo8(-24)
	...
	ldi r24,lo8(70)
	call disp_version
	.stabn	68,0,198,.LM44-.LFBB3
.LM44:
	call sd_card_cs_init
	.stabn	68,0,201,.LM45-.LFBB3
.LM45:
	call keybrd_hold_repeat_disable
	.stabn	68,0,207,.LM46-.LFBB3
.LM46:
	call codec_init
	.stabn	68,0,208,.LM47-.LFBB3
.LM47:
	cpse r24,__zero_reg__
	rjmp .L8
.L13:
	.stabn	68,0,210,.LM48-.LFBB3
.LM48:
	ldi r22,lo8(1)
	ldi r23,0
	ldi r24,lo8(.LC2)
	ldi r25,hi8(.LC2)
	call disp_msg
	.stabn	68,0,212,.LM49-.LFBB3
.LM49:
	ldi r17,lo8(1)
.L9:
	.stabn	68,0,271,.LM50-.LFBB3
.LM50:
	call keybrd_clear_events
	.stabn	68,0,274,.LM51-.LFBB3
.LM51:
	cpse r17,__zero_reg__
	rjmp .L42
.L25:
	.stabn	68,0,277,.LM52-.LFBB3
.LM52:
	call keybrd_get_event
	mov r17,r24
	.stabn	68,0,279,.LM53-.LFBB3
.LM53:
	tst r24
	breq .L15
	.stabn	68,0,280,.LM54-.LFBB3
.LM54:
	ldi r20,lo8(6)
	ldi r22,lo8(3)
	ldi r24,lo8(100)
	...
	call tonegen_beep
.L15:
	.stabn	68,0,282,.LM55-.LFBB3
.LM55:
	call menu_is_active
	.stabn	68,0,282,.LM56-.LFBB3
.LM56:
	tst r24
	brne .+2
	rjmp .L16
	.stabn	68,0,282,.LM57-.LFBB3
.LM57:
	tst r17
	breq .L18
	.stabn	68,0,284,.LM58-.LFBB3
.LM58:
	mov r24,r17
	call menu_handle
	.stabn	68,0,285,.LM59-.LFBB3
.LM59:
	sbrs r24,0
	rjmp .L16
	.stabn	68,0,287,.LM60-.LFBB3
.LM60:
	sbrc r24,2
	.stabn	68,0,289,.LM61-.LFBB3
.LM61:
	call rtc_show
.L18:
...
.LM65:
	...
	out __SP_L__,r28
.L12:
	.stabn	68,0,223,.LM66-.LFBB3
.LM66:
	call sd_card_init
	.stabn	68,0,223,.LM67-.LFBB3
.LM67:
	cpse r24,__zero_reg__
	rjmp .L10
	.stabn	68,0,226,.LM68-.LFBB3
.LM68:
	ldi r22,lo8(1)
	ldi r23,0
	ldi r24,lo8(.LC4)
...
.LM69:
	call keybrd_get_event
	.stabn	68,0,231,.LM70-.LFBB3
.LM70:
/* #APP */
 ;  231 "src/main.c" 1
	nop
 ;  0 "" 2
	.stabn	68,0,232,.LM71-.LFBB3
.LM71:
/* #NOAPP */
	cpi r24,lo8(1)
	brne .L11
	.stabn	68,0,235,.LM72-.LFBB3
.LM72:
	ldi r22,lo8(-112)
	ldi r23,lo8(1)
	ldi r24,lo8(.LC5)
	ldi r25,hi8(.LC5)
	call disp_msg
	.stabn	68,0,223,.LM73-.LFBB3
.LM73:
	rjmp .L12
.L10:
	.stabn	68,0,239,.LM74-.LFBB3
.LM74:
	ldi r22,lo8(-112)
	ldi r23,lo8(1)
	ldi r24,lo8(.LC6)
	ldi r25,hi8(.LC6)
	call disp_msg
	.stabn	68,0,247,.LM75-.LFBB3
.LM75:
	call codec_process_patches
	.stabn	68,0,247,.LM76-.LFBB3
.LM76:
	tst r24
	brne .+2
	rjmp .L13
	.stabn	68,0,256,.LM77-.LFBB3
.LM77:
	call config_init
	.stabn	68,0,263,.LM78-.LFBB3
.LM78:
	call rtc_show
	.stabn	68,0,265,.LM79-.LFBB3
.LM79:
	call batmon_start
	.stabn	68,0,267,.LM80-.LFBB3
.LM80:
	call sound_start
	.stabn	68,0,156,.LM81-.LFBB3
.LM81:
	ldi r17,0
	rjmp .L9
.L16:
	.stabn	68,0,297,.LM82-.LFBB3
.LM82:
	cpi r17,lo8(-127)
	breq .L20
	brsh .L21
	...
	breq .+2
	rjmp .L18
	.stabn	68,0,341,.LM83-.LFBB3
.LM83:
	call codec_get_status
	.stabn	68,0,341,.LM84-.LFBB3
.LM84:
	or r24,r25
	breq .L24
	.stabn	68,0,342,.LM85-.LFBB3
.LM85:
	call codec_stop
	rjmp .L18
.L21:
	.stabn	68,0,297,.LM86-.LFBB3
.LM86:
	cpi r17,lo8(-124)
	breq .L23
	.stabn	68,0,301,.LM87-.LFBB3
.LM87:
	ldi r22,lo8(gs(deferred_clear_wakeup_timer))
	ldi r23,hi8(gs(deferred_clear_wakeup_timer))
	ldi r25,0
	ldi r24,0
	.stabn	68,0,297,.LM88-.LFBB3
.LM88:
	cpi r17,lo8(-104)
	breq .+2
	rjmp .L18
.L43:
	.stabn	68,0,345,.LM89-.LFBB3
.LM89:
	call deferred_start
	rjmp .L18
.L23:
	.stabn	68,0,308,.LM90-.LFBB3
.LM90:
	call rtc_hide
	.stabn	68,0,310,.LM91-.LFBB3
.LM91:
	call menu_enter
	.stabn	68,0,312,.LM92-.LFBB3
.LM92:
	rjmp .L18
.L20:
	.stabn	68,0,317,.LM93-.LFBB3
.LM93:
	call power_off
	.stabn	68,0,319,.LM94-.LFBB3
.LM94:
	rjmp .L18
.L24:
	.stabn	68,0,345,.LM95-.LFBB3
.LM95:
