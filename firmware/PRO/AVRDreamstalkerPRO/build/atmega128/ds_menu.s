...
.Lscope3:
	.stabs	"trigger_log_handler:f(0,1)",36,0,0,trigger_log_handler
	.stabs	"key_event:P(0,13)=(0,4)",64,0,0,24
	.stabs	"keybrd_event_t:t(0,13)",128,0,0,0
	.type	trigger_log_handler, @function
trigger_log_handler:
...
.LM19:
	ret
	.size	trigger_log_handler, .-trigger_log_handler
.Lscope4:
...
.Lscope32:
	.stabs	"trigger_log_activate:f(0,1)",36,0,0,trigger_log_activate
	.type	trigger_log_activate, @function
trigger_log_activate:
...
.LM202:
	jmp keybrd_hold_repeat_fast
	.size	trigger_log_activate, .-trigger_log_activate
.Lscope33:
...
.Lscope39:
	.stabs	"trigger_count_display:f(0,1)",36,0,0,trigger_count_display
	.stabs	"remd_sensitivity_t:t(0,29)=(0,4)",128,0,0,0
	.type	trigger_count_display, @function
...
.LM303:
	ldi r25,0
	jmp disp_num
	.size	trigger_count_display, .-trigger_count_display
.Lscope40:
...
desc_root:
	...
	.zero	6
	.zero	1
	.word	gs(trigger_count_display)
	.zero	9
	.string	"trLo"
	.zero	6
	.zero	1
	.word	gs(trigger_log_activate)
	.word	gs(disable_key_hold_repeat)
	.word	gs(trigger_log_handler)
	.zero	5
	.string	"d-%.2i"
	.zero	4
	.byte	2
