...
__tmp_reg__ = 0
__zero_reg__ = 1
	.stabs	"src/core/ds_deferred.c",100,0,2,.Ltext0
	.text
.Ltext0:
...
.Lscope1:
	.stabs	"deferred_start:F(0,2)=r(0,2);-32768;32767;",36,0,0,deferred_start
	.stabs	"int:t(0,2)",128,0,0,0
	.stabs	"i:P(0,2)",64,0,0,24
	.stabs	"handler:P(0,3)=(0,4)=*(0,5)=f(0,1)",64,0,0,18
	.stabs	"pfn_deferred_handler:t(0,3)",128,0,0,0
...
.L6:
/* epilogue start */
	.stabn	68,0,55,.LM15-.LFBB3
.LM15:
	ret
	.size	deferred_is_running, .-deferred_is_running
.Lscope3:
	.stabs	"deferred_stop:F(0,1)",36,0,0,deferred_stop
	.stabs	"pd:P(0,6)=*(0,7)=(0,8)=xss_deferred_context:",64,0,0,24
	.stabs	"s_deferred_context:T(0,8)=s7handler:(0,3),0,16;ticks:(0,9)=(0,10)=r(0,10);0;4294967295;,16,32;flags:(0,11)=(0,12)=r(0,12);0;255;,48,8;;",128,0,0,0
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,59,.LM17-.LFBB4
.LM17:
	movw r30,r24
	std Z+1,__zero_reg__
	st Z,__zero_reg__
/* epilogue start */
	.stabn	68,0,60,.LM18-.LFBB4
.LM18:
	ret
...
.LBB8:
.LBB9:
	.stabn	68,0,54,.LM20-.LFBB5
.LM20:
	lds r24,dd
	lds r25,dd+1
.LBE9:
.LBE8:
	.stabn	68,0,67,.LM21-.LFBB5
.LM21:
	or r24,r25
	breq .L9
	.stabn	68,0,68,.LM22-.LFBB5
.LM22:
	lds r24,dd+2
	lds r25,dd+2+1
	lds r26,dd+2+2
	lds r27,dd+2+3
	.stabn	68,0,68,.LM23-.LFBB5
.LM23:
	adiw r24,1
	...
	sts dd+2+2,r26
	sts dd+2+3,r27
	.stabn	68,0,69,.LM24-.LFBB5
.LM24:
	lds r30,dd
	lds r31,dd+1
	.stabn	68,0,69,.LM25-.LFBB5
.LM25:
	ldi r24,lo8(dd)
	ldi r25,hi8(dd)
	eicall
...
.LBB11:
.LBB10:
	.stabn	68,0,54,.LM26-.LFBB5
.LM26:
	lds r24,dd+7
	lds r25,dd+7+1
.LBE10:
.LBE11:
	.stabn	68,0,67,.LM27-.LFBB5
.LM27:
	or r24,r25
	breq .L8
	.stabn	68,0,68,.LM28-.LFBB5
.LM28:
	lds r24,dd+9
	lds r25,dd+9+1
	lds r26,dd+9+2
	lds r27,dd+9+3
	.stabn	68,0,68,.LM29-.LFBB5
.LM29:
	adiw r24,1
	adc r26,__zero_reg__
	adc r27,__zero_reg__
	...
	sts dd+9+2,r26
	sts dd+9+3,r27
	.stabn	68,0,69,.LM30-.LFBB5
.LM30:
	lds r30,dd+7
	lds r31,dd+7+1
	.stabn	68,0,69,.LM31-.LFBB5
.LM31:
	ldi r24,lo8(dd+7)
	ldi r25,hi8(dd+7)
	eijmp
...
.Lscope5:
	.local	dd
	.comm	dd,14,1
	.stabs	"dd:S(0,13)=ar(0,14)=r(0,14);0;65535;;0;1;(0,7)",40,0,0,dd
