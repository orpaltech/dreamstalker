...
.Ltext0:
	...
	.stabs	"led:P(0,5)=r(0,5);-32768;32767;",64,0,0,20
	.stabs	"trans:P(0,6)=(0,4)",64,0,0,24
	.stabs	"int:t(0,5)",128,0,0,0
	.type	led_transition, @function
led_transition:
	.stabn	68,0,66,.LM0-.LFBB1
.LM0:
.LFBB1:
/* prologue: function */
/* frame size = 0 */
...
.LM3:
	...
	or r24,r25
	brne .L1
	.stabn	68,0,81,.LM4-.LFBB1
.LM4:
	in r24,0xd
	or r24,r18
.L8:
	.stabn	68,0,85,.LM5-.LFBB1
.LM5:
	out 0xd,r24
.L1:
/* epilogue start */
	.stabn	68,0,88,.LM6-.LFBB1
.LM6:
	ret
.L7:
	.stabn	68,0,69,.LM7-.LFBB1
.LM7:
	ldi r18,lo8(8)
	rjmp .L2
.L3:
	.stabn	68,0,77,.LM8-.LFBB1
.LM8:
	in r24,0xd
	com r18
	and r18,r24
	out 0xd,r18
	.stabn	68,0,78,.LM9-.LFBB1
.LM9:
	ret
.L4:
	.stabn	68,0,85,.LM10-.LFBB1
.LM10:
	in r24,0xd
	eor r24,r18
	rjmp .L8
...
.global	__fixunssfsi
	...
	.stabs	"float:t(0,7)=r(0,5);4;0;",128,0,0,0
	.stabs	"led:P(0,8)=(0,9)=eLED1:0,LED2:1,;",64,0,0,14
	.stabs	"brightness:p(0,2)",160,0,0,1
	.stabs	"duty_cycle:P(0,2)",64,0,0,16
	.stabs	" :T(0,9)",128,0,0,0
.global	leds_pulse
...
.Lscope3:
	...
	.stabs	"uint16_t:t(0,10)=(0,11)=r(0,11);0;65535;",128,0,0,0
	.stabs	"unsigned int:t(0,11)",128,0,0,0
.global	leds_init
	.type	leds_init, @function
leds_init:
	.stabn	68,0,131,.LM37-.LFBB4
.LM37:
.LFBB4:
/* prologue: function */
/* frame size = 0 */
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,133,.LM38-.LFBB4
.LM38:
	in r24,0xd
	andi r24,lo8(-25)
	out 0xd,r24
	.stabn	68,0,134,.LM39-.LFBB4
.LM39:
	in r24,0xe
	andi r24,lo8(-25)
	out 0xe,r24
	.stabn	68,0,142,.LM40-.LFBB4
.LM40:
	ldi r30,lo8(113)
	ldi r31,0
	ld r24,Z
	andi r24,lo8(-40)
	st Z,r24
	.stabn	68,0,149,.LM41-.LFBB4
.LM41:
	ldi r24,lo8(-93)
	sts 144,r24
	.stabn	68,0,150,.LM42-.LFBB4
.LM42:
	ldi r24,lo8(8)
	sts 145,r24
	.stabn	68,0,152,.LM43-.LFBB4
.LM43:
	ldi r24,lo8(-1)
	ldi r25,lo8(3)
	sts 152+1,r25
	sts 152,r24
	.stabn	68,0,153,.LM44-.LFBB4
.LM44:
	sts 154+1,r25
	sts 154,r24
	.stabn	68,0,155,.LM45-.LFBB4
.LM45:
