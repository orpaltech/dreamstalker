...
.L5:
	...
	ldi r25,0
.L2:
	.stabn	68,0,488,.LM2-.LFBB1
.LM2:
	sts cfg+11,r24
.LBB272:
.LBB273:
	.stabn	68,0,575,.LM3-.LFBB1
.LM3:
	sts cfg+15,r20
.LBE273:
.LBE272:
...
.LBB294:
.LBB295:
	.stabn	68,0,430,.LM14-.LFBB3
.LM14:
	ldi r24,lo8(2)
	ldi r25,lo8(-128)
	sts cfg+1,r25
	sts cfg,r24
	.stabn	68,0,431,.LM15-.LFBB3
.LM15:
	ldi r20,lo8(21)
	ldi r21,0
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,347,.LM17-.LFBB4
.LM17:
	call rtc_hide
	.stabn	68,0,348,.LM18-.LFBB4
.LM18:
	ldi r22,lo8(-12)
	ldi r23,lo8(1)
	ldi r24,lo8(.LC0)
	ldi r25,hi8(.LC0)
	call disp_msg
	.stabn	68,0,350,.LM19-.LFBB4
.LM19:
	call codec_stop
	.stabn	68,0,352,.LM20-.LFBB4
.LM20:
	call disp_disable
	.stabn	68,0,354,.LM21-.LFBB4
.LM21:
	call batmon_stop
	.stabn	68,0,355,.LM22-.LFBB4
.LM22:
	call adc_disable
	.stabn	68,0,358,.LM23-.LFBB4
.LM23:
	ldi r24,lo8(1)
	ldi r25,0
	call rtc_start
	.stabn	68,0,363,.LM24-.LFBB4
.LM24:
	in r24,0x35
	andi r24,lo8(-29)
	ori r24,lo8(24)
	out 0x35,r24
.L9:
	.stabn	68,0,366,.LM25-.LFBB4
.LM25:
	ldi r24,lo8(1)
	call keybrd_enable_irq
	.stabn	68,0,371,.LM26-.LFBB4
.LM26:
	in r24,0x35
	ori r24,lo8(32)
	out 0x35,r24
/* #APP */
 ;  371 "src/ds_config.c" 1
	sleep
...
/* #NOAPP */
	...
	andi r24,lo8(-33)
	out 0x35,r24
	.stabn	68,0,373,.LM27-.LFBB4
.LM27:
	ldi r24,lo8(1)
	call keybrd_disable_irq
	.stabn	68,0,375,.LM28-.LFBB4
.LM28:
	call keybrd_get_irq_keys
	.stabn	68,0,375,.LM29-.LFBB4
.LM29:
	cpi r24,lo8(1)
	brne .L9
	.stabn	68,0,378,.LM30-.LFBB4
.LM30:
	call rtc_wait_for_tick
	.stabn	68,0,379,.LM31-.LFBB4
.LM31:
	ldi r25,0
	ldi r24,0
	call rtc_start
	.stabn	68,0,381,.LM32-.LFBB4
.LM32:
	call disp_enable
	.stabn	68,0,383,.LM33-.LFBB4
.LM33:
	call adc_enable
	.stabn	68,0,384,.LM34-.LFBB4
.LM34:
	call batmon_start
	.stabn	68,0,386,.LM35-.LFBB4
.LM35:
	call rtc_show
	.stabn	68,0,389,.LM36-.LFBB4
.LM36:
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,463,.LM41-.LFBB6
.LM41:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(3)
	brsh .L12
	.stabn	68,0,464,.LM42-.LFBB6
.LM42:
	sts cfg+10,r24
.L12:
/* epilogue start */
	.stabn	68,0,465,.LM43-.LFBB6
.LM43:
	ret
...
.LBB299:
.LBB300:
	.stabn	68,0,481,.LM45-.LFBB7
.LM45:
	sts cfg+10,__zero_reg__
/* epilogue start */
.LBE300:
.LBE299:
	.stabn	68,0,477,.LM46-.LFBB7
.LM46:
	ret
...
.LBB400:
.LBB401:
	.stabn	68,0,481,.LM60-.LFBB10
.LM60:
	sts cfg+10,__zero_reg__
.LBE401:
.LBE400:
.LBE399:
	.stabn	68,0,300,.LM61-.LFBB10
.LM61:
	call set_default_wakeup_mode
.LBB402:
.LBB403:
.LBB404:
	.stabn	68,0,567,.LM62-.LFBB10
.LM62:
	sts cfg+12,r29
.LBE404:
.LBE403:
...
.LBB427:
.LBB428:
	.stabn	68,0,430,.LM71-.LFBB10
.LM71:
	ldi r24,lo8(2)
	ldi r25,lo8(-128)
	sts cfg+1,r25
	sts cfg,r24
	.stabn	68,0,431,.LM72-.LFBB10
.LM72:
	ldi r20,lo8(21)
	ldi r21,0
	ldi r22,lo8(eeprom_cfg)
...
.LBE428:
.LBE427:
	.stabn	68,0,325,.LM73-.LFBB10
.LM73:
	pop r29
	pop r28
.LBB430:
.LBB429:
	.stabn	68,0,431,.LM74-.LFBB10
.LM74:
	jmp eeprom_update_block
.L19:
/* epilogue start */
...
.L__stack_usage = 0
	movw r18,r24
	.stabn	68,0,564,.LM135-.LFBB39
.LM135:
	sbiw r24,3
	cpi r24,-18
	cpc r25,__zero_reg__
	brsh .L49
	.stabn	68,0,564,.LM136-.LFBB39
.LM136:
	sts cfg+3+1,r19
	sts cfg+3,r18
.L49:
/* epilogue start */
	.stabn	68,0,564,.LM137-.LFBB39
.LM137:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,565,.LM159-.LFBB50
.LM159:
	cpi r24,lo8(10)
	brsh .L66
	.stabn	68,0,565,.LM160-.LFBB50
.LM160:
	sts cfg+5,r24
.L66:
/* epilogue start */
	.stabn	68,0,565,.LM161-.LFBB50
.LM161:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,566,.LM171-.LFBB55
.LM171:
	cpi r24,lo8(10)
	brsh .L76
	.stabn	68,0,566,.LM172-.LFBB55
.LM172:
	sts cfg+6,r24
.L76:
/* epilogue start */
	.stabn	68,0,566,.LM173-.LFBB55
.LM173:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,567,.LM183-.LFBB60
.LM183:
	cpi r24,lo8(10)
	brsh .L86
	.stabn	68,0,567,.LM184-.LFBB60
.LM184:
	sts cfg+12,r24
.L86:
/* epilogue start */
	.stabn	68,0,567,.LM185-.LFBB60
.LM185:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,568,.LM197-.LFBB66
.LM197:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L96
	.stabn	68,0,568,.LM198-.LFBB66
.LM198:
	sts cfg+7,r24
.L96:
/* epilogue start */
	.stabn	68,0,568,.LM199-.LFBB66
.LM199:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,569,.LM211-.LFBB72
.LM211:
	cpi r24,lo8(65)
	brsh .L106
	.stabn	68,0,569,.LM212-.LFBB72
.LM212:
	sts cfg+8,r24
.L106:
/* epilogue start */
	.stabn	68,0,569,.LM213-.LFBB72
.LM213:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,570,.LM229-.LFBB80
.LM229:
	ldi r25,lo8(-2)
	add r25,r24
	cpi r25,lo8(6)
	brsh .L116
	.stabn	68,0,570,.LM230-.LFBB80
.LM230:
	sts cfg+9,r24
.L116:
/* epilogue start */
	.stabn	68,0,570,.LM231-.LFBB80
.LM231:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,573,.LM259-.LFBB94
.LM259:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L152
	.stabn	68,0,573,.LM260-.LFBB94
.LM260:
	sts cfg+13,r24
.L152:
/* epilogue start */
	.stabn	68,0,573,.LM261-.LFBB94
.LM261:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,574,.LM271-.LFBB99
.LM271:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L162
	.stabn	68,0,574,.LM272-.LFBB99
.LM272:
	sts cfg+14,r24
.L162:
/* epilogue start */
	.stabn	68,0,574,.LM273-.LFBB99
.LM273:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,575,.LM283-.LFBB104
.LM283:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L172
	.stabn	68,0,575,.LM284-.LFBB104
.LM284:
	sts cfg+15,r24
.L172:
/* epilogue start */
	.stabn	68,0,575,.LM285-.LFBB104
.LM285:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,576,.LM295-.LFBB109
.LM295:
	ldi r25,lo8(-1)
	add r25,r24
	cpi r25,lo8(9)
	brsh .L182
	.stabn	68,0,576,.LM296-.LFBB109
.LM296:
	sts cfg+16,r24
.L182:
/* epilogue start */
	.stabn	68,0,576,.LM297-.LFBB109
.LM297:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,577,.LM309-.LFBB115
.LM309:
	cpi r24,lo8(100)
	brsh .L192
	.stabn	68,0,577,.LM310-.LFBB115
.LM310:
	sts cfg+17,r24
.L192:
/* epilogue start */
	.stabn	68,0,577,.LM311-.LFBB115
.LM311:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,578,.LM321-.LFBB120
.LM321:
	cpi r24,lo8(100)
	brsh .L202
	.stabn	68,0,578,.LM322-.LFBB120
.LM322:
	sts cfg+18,r24
.L202:
/* epilogue start */
	.stabn	68,0,578,.LM323-.LFBB120
.LM323:
	ret
