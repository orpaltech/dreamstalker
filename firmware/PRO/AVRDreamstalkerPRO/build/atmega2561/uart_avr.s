...
.LM54:
	lds r25,u0+20
	.stabn	68,0,224,.LM55-.LFBB4
.LM55:
	cp r25,r18
	cpc __zero_reg__,r19
	breq .L31
	.stabn	68,0,227,.LM56-.LFBB4
.LM56:
	movw r30,r18
	subi r30,lo8(-(u0))
	sbci r31,hi8(-(u0))
	std Z+11,r24
	.stabn	68,0,228,.LM57-.LFBB4
.LM57:
	sts u0+19,r18
	.stabn	68,0,231,.LM58-.LFBB4
.LM58:
	lds r24,193
	ori r24,lo8(32)
	sts 193,r24
/* epilogue start */
	.stabn	68,0,232,.LM59-.LFBB4
.LM59:
	ret
...
.LM75:
	adiw r24,1
	.stabn	68,0,256,.LM76-.LFBB6
.LM76:
	andi r24,7
	clr r25
	.stabn	68,0,257,.LM77-.LFBB6
.LM77:
	sts u0+9,r24
	.stabn	68,0,260,.LM78-.LFBB6
.LM78:
	subi r24,lo8(-(u0))
	sbci r25,hi8(-(u0))
	movw r30,r24
	ld r24,Z
	.stabn	68,0,262,.LM79-.LFBB6
.LM79:
	lds r25,u0+10
/* epilogue start */
	.stabn	68,0,263,.LM80-.LFBB6
.LM80:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,289,.LM102-.LFBB9
.LM102:
	lds r24,193
	andi r24,lo8(-25)
	sts 193,r24
.L42:
	.stabn	68,0,293,.LM103-.LFBB9
.LM103:
	lds r24,192
	sbrs r24,7
/* epilogue start */
	.stabn	68,0,295,.LM104-.LFBB9
.LM104:
	ret
.L43:
	.stabn	68,0,294,.LM105-.LFBB9
.LM105:
	lds r24,198
	rjmp .L42
