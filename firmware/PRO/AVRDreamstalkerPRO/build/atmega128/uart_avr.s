...
.LM54:
	...
	breq .L30
	.stabn	68,0,230,.LM55-.LFBB4
.LM55:
	movw r30,r18
	subi r30,lo8(-(u0))
	sbci r31,hi8(-(u0))
	std Z+11,r24
	.stabn	68,0,231,.LM56-.LFBB4
.LM56:
	sts u0+19,r18
	.stabn	68,0,234,.LM57-.LFBB4
.LM57:
	sbi 0xa,5
/* epilogue start */
	.stabn	68,0,235,.LM58-.LFBB4
.LM58:
	ret
...
.L33:
	.stabn	68,0,241,.LM60-.LFBB5
.LM60:
	cp r28,r16
	cpc r29,r17
	brne .L34
/* epilogue start */
	.stabn	68,0,245,.LM61-.LFBB5
.LM61:
	pop r29
	pop r28
	pop r17
...
.LM75:
	andi r24,7
	clr r25
	.stabn	68,0,260,.LM76-.LFBB6
.LM76:
	sts u0+9,r24
	.stabn	68,0,263,.LM77-.LFBB6
.LM77:
	subi r24,lo8(-(u0))
	sbci r25,hi8(-(u0))
	movw r30,r24
	ld r24,Z
	.stabn	68,0,265,.LM78-.LFBB6
.LM78:
	lds r25,u0+10
/* epilogue start */
	.stabn	68,0,266,.LM79-.LFBB6
.LM79:
	ret
...
/* stack size = 0 */
.L__stack_usage = 0
	.stabn	68,0,292,.LM101-.LFBB9
.LM101:
	in r24,0xa
	andi r24,lo8(-25)
	out 0xa,r24
.L41:
	.stabn	68,0,296,.LM102-.LFBB9
.LM102:
	sbis 0xb,7
/* epilogue start */
	.stabn	68,0,298,.LM103-.LFBB9
.LM103:
	ret
.L42:
	.stabn	68,0,297,.LM104-.LFBB9
.LM104:
	in r24,0xc
	rjmp .L41
